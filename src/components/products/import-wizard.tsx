...
const steps = [
  { number: 1, title: "Upload", description: "Select Excel file", icon: Upload },
  { number: 2, title: "Validate", description: "Review issues", icon: ClipboardCheck },
  { number: 3, title: "Categories", description: "Assign HSN & GST", icon: Tags },
  { number: 4, title: "Import", description: "Review & commit", icon: FileCheck },
];

export function ImportWizardSteps({ currentStep }: ImportWizardStepsProps) {
  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between relative">
        ...
        <div
          className="absolute top-6 left-0 right-0 h-0.5 bg-zinc-800"
          ...
          return (
            <div key={step.number} className="flex flex-col items-center relative z-10">
              ...
              <div className="mt-3 text-center">
                <p className={cn("text-sm font-medium", isCompleted || isActive ? "text-foreground" : "text-muted-foreground")}>
                  {step.title}
                </p>
